    ...
    <body>
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    <%  
                        ...
                        List<Recluso> listR = recluso.mostrarReclusos(tmpoCarcel.getId());
                    ...
                    %>
                    <tr  id="<%=tmpo.getPersona().getCedula()%>">
                        <th scope="row"><%=tmpo.getPersona().getCedula() %></th>
                        <td><%=tmpo.getPersona().getNombre() %></td>
                        <td><%=tmpo.getPersona().getApellido() %></td>
                        <td><%=tmpo.getCod_recluso() %></td>
                        <td><a href="Control?accion=verInfo&id=<%=tmpo.getPersona().getCedula()%>">VER</a></td>
                        <td><a href="modificarRecluso.jsp">MODIFICAR</a></td>
                    </tr>
        ...
        <div class = "clase1">
            ...
            <div class="list-group" >
                <a class="text-center clase6" href="#"><img src="<%=user.getUrl() %>" alt=""  style=" width: 60%; height: 60%; "class="rounded-circle"><div class="text-white text-center"><%=user.getNombre() %></div></a>
                <a class="list-group-item list-group-item-action text-center clase3 clase6 text-white dirStyle" href="reclusos.jsp">Reclusos</a>
