    ...
    <body>
            ...
            <table class="table table-striped">
                <thead>
                    <tr>
                        ...
                        <th scope="col" style=" width: 25%">Cod Recluso</th>
                ...
                <tbody>
                    <tr>
                        ...
                        <td><a href="versentencia.jsp">VER</a></td>
                        <td><a href="modificarsentencia.jsp">MODIFICAR</a></td>
                    </tr>
        ...
        <div class = "clase1">
            ...
            <div class="list-group" >
                ...
                <a class="list-group-item list-group-item-action text-center clase3 clase6 text-white dirStyle" href="sentencias.jsp">Sentencias</a>
