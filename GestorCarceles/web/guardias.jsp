    ...
    <body>
        <div class="clase2 ">
           ...
           <table  class="clase4"><tr >
            ...
            <nav class="navbar navbar-light bg-light">
                ...
                <div class="justify-content-end"><a href="registrarGuardia.jsp" class="text-blue">AÑADIR<img src="imagenes/aniadir.png" class="rounded-circle" style="width: 100px; height: 50px;"></a></div>
            </nav>
            <table class="table table-striped">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>Otto</td>
                        <td>@mdo</td>
                        <td><a href="verGuardia.jsp">VER</a></td>
                        <td><a href="modificarGuardia.jsp">MODIFICAR</a></td>
                    </tr>
        ...
        <div class = "clase1">
            ...
            <div class="list-group" >
                ...
                <a class="list-group-item list-group-item-action text-center clase3 clase6 text-white dirStyle" href="guardias.jsp">Guardias</a>
