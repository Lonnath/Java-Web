    ...
    <body>
           ...
           <ul class="nav justify-content-end clase6 ">
            ...
            <nav class="navbar navbar-light bg-light">
                <form class="form-inline">
                    <input class="form-control mr-sm-2" type="search" placeholder="Buscar por id " aria-label="Search">
            ...
            <table class="table table-striped">
                <thead>
                    <tr>
                        <th scope="col" style="width: 50%;" >ID CONSULTA</th>
                        <th scope="col" style="width: 50%;" >ID PABELLON</th>
                        <th scope="col" style="width: 50%;">NIVEL RIESGO</th>
                    </tr>
                </thead>
                <tbody>
                   <%
                        PabellonDAO pabellon = new PabellonDAO();
                        List<Pabellon> pabellonList = pabellon.getPabellon(user.getIdcarcel());
                        Iterator<Pabellon> pabellonIterator = pabellonList.iterator();
                        Pabellon tempoPabe = null;
                        while(pabellonIterator.hasNext()){
                            tempoPabe = pabellonIterator.next();
                            String tmpoStringo = new Nivel_RiesgoDAO().getRiesgo(tempoPabe.getId_nivelriesgo());
                   %> <tr>
                        <th><%=tempoPabe.getId() %></th>
                        <th><%=tempoPabe.getId_nombre()%></th>
        ...
        <div class = "clase1">
            ...
            <div class="list-group" >
                ...
                <a class="list-group-item list-group-item-action text-center clase3 clase6 text-white dirStyle" href="pabellones.jsp">Pabellones</a>
