    ...
    <body>
        <div class="clase2 ">
            ...
            <table class="table table-striped">
                <thead>
                    <tr>
                        <th scope="col" style="width: 20%;" >ID CONSULTA</th>
                        <th scope="col" style="width: 20%;" >ID CELDA</th>
                        <th scope="col" style="width: 20%;">Capacidad</th>
                        <th scope="col" style="width: 20%;" >Piso</th>
                        <th scope="col" style="width: 20%;">Id Pabellon</th>
                    </tr>
                </thead>
                <tbody>
                    <%
                        CeldaDAO celdas = new CeldaDAO();
                        List<Celda> listCeldas = celdas.getCeldas(user.getIdcarcel());
                        Iterator<Celda> tmpoIterator = listCeldas.iterator();
                        Celda celdos = null;
                        while(tmpoIterator.hasNext()){
                            celdos = tmpoIterator.next();
                        
                    %>
                    
                    <tr>
                        <th><%=celdos.getId()%></th>
                        <th><%=celdos.getId_nombre()%></th>
                        <th><%=celdos.getCapacidad()%></th>
                        <th><%=celdos.getPiso() %></th>
                        <th><%=celdos.getId_pabellon() %></th>
                    </tr>
                   <%
                        }
                   %>
        ...
        <div class = "clase1">
            ...
            <div class="list-group" >
                ...
                <a class="list-group-item list-group-item-action text-center clase3 clase6 text-white dirStyle" href="celdas.jsp">Celdas</a>
